...
issue](https://github.com/cisagov/action-apb/issues) in
...
request](https://github.com/cisagov/action-apb/pulls),
...
```console
cd action-apb
pyenv virtualenv <python_version_to_use> action-apb
pyenv local action-apb
